...
HD_PWD='C:/Users/lenovo/PROJECT-20_GPIO_AND_UART_MICROBLAZE/PROJECT-20_GPIO_AND_UART_MICROBLAZE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GPIO_UART_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GPIO_UART_wrapper.tcl -notrace

...
HD_PWD='C:/Users/lenovo/UART_TX_AND_RX_TO_BLE/UART_TX_AND_RX_TO_BLE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BLE_UART_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BLE_UART_wrapper.tcl -notrace

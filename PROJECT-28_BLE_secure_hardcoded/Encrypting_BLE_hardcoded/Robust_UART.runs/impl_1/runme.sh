...
HD_PWD='C:/Users/lenovo/Robust_UART/Robust_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_secure_BLE_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_secure_BLE_wrapper.tcl -notrace

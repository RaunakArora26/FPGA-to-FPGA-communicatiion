...
HD_PWD='C:/Users/lenovo/Robust_UART/Robust_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_secure_BLE_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_secure_BLE_wrapper.tcl

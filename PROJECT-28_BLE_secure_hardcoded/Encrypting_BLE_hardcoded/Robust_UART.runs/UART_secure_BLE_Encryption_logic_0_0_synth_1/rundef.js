...
ISEStep( "vivado",
         "-log UART_secure_BLE_Encryption_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_secure_BLE_Encryption_logic_0_0.tcl" );

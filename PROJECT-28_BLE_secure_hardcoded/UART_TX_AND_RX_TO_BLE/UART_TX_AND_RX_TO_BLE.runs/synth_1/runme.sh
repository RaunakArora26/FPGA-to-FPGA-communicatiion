...
HD_PWD='C:/Users/lenovo/UART_TX_AND_RX_TO_BLE/UART_TX_AND_RX_TO_BLE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BLE_UART_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BLE_UART_wrapper.tcl

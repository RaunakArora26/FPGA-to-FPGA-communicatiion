...
HD_PWD='C:/Users/lenovo/Decrypting_BLE_hardcoded/Decrypting_BLE_hardcoded.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BLE_Decryption_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BLE_Decryption_wrapper.tcl -notrace

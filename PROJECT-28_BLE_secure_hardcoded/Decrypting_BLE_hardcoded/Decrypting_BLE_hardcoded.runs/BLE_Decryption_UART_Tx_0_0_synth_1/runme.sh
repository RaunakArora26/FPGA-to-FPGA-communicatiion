...
HD_PWD='C:/Users/lenovo/Decrypting_BLE_hardcoded/Decrypting_BLE_hardcoded.runs/BLE_Decryption_UART_Tx_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BLE_Decryption_UART_Tx_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BLE_Decryption_UART_Tx_0_0.tcl

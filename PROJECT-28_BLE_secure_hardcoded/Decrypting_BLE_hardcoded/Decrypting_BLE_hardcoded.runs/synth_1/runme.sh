...
HD_PWD='C:/Users/lenovo/Decrypting_BLE_hardcoded/Decrypting_BLE_hardcoded.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BLE_Decryption_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BLE_Decryption_wrapper.tcl

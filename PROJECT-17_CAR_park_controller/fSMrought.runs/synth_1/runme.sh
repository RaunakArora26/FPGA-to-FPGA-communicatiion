...
HD_PWD='C:/Users/lenovo/fSMrought/fSMrought.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maincarParkController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source maincarParkController.tcl

...
HD_PWD='C:/Users/lenovo/fSMrought/fSMrought.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log maincarParkController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source maincarParkController.tcl -notrace

...
HD_PWD='C:/Users/lenovo/PWM_try/PWM_try.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_RGB_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PWM_RGB_led.tcl -notrace

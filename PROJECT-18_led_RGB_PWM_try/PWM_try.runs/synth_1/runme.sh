...
HD_PWD='C:/Users/lenovo/PWM_try/PWM_try.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_RGB_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_RGB_led.tcl

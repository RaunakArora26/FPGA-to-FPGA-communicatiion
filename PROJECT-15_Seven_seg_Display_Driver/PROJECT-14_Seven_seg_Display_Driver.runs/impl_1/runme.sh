...
HD_PWD='C:/Users/lenovo/PROJECT-14_Seven_seg_Display_Driver/PROJECT-14_Seven_seg_Display_Driver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MainTopModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MainTopModule.tcl -notrace

...
HD_PWD='C:/Users/lenovo/PROJECT-14_Seven_seg_Display_Driver/PROJECT-14_Seven_seg_Display_Driver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MainTopModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MainTopModule.tcl

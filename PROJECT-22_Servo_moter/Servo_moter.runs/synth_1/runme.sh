...
HD_PWD='C:/Users/lenovo/Servo_moter/Servo_moter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Try.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Try.tcl

...
HD_PWD='C:/Users/lenovo/Servo_moter/Servo_moter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Try.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Try.tcl -notrace
